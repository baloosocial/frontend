...
(function () {
    ...
    Tick = (function () {
        function Tick(element, options) {
            ...
            this.value = Number(this.element.html().replace(new RegExp("\\" + this.options.separator, "g"), ''));
        ...
        Tick.prototype.render = function () {
            ...
            //var regexp = new RegExp(this.options.separator + "g");
            //this.value = Number(this.element.html().replace(regexp, ''));
